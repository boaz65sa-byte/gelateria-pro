...
const SettingsIcon = ({ className = '' }) => (
  <svg className={`w-5 h-5 ${className}`} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      {({ isActive }) => (
                        <>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className={`text-xs leading-tight truncate font-sans ${isActive ? 'text-white/70' : 'text-espresso-400 dark:text-espresso-400'}`}>
                              {item.sub}
                            </p>
                          </div>
                        </>
