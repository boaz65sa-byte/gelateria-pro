      ...
      <div className="space-y-6">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-espresso-400 font-sans">ניהול ספקים וחיבורי WhatsApp</p>
          </div>
          <div className="flex gap-2">
            <Button variant="primary" onClick={openAdd}><Icons.Plus className="w-4 h-4" /> ספק חדש</Button>
